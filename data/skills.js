export const skills = [
	{
		icon: require("../public/assets/Visual Design.png"),
		title: "Visual Design",
		description:
	...
	{
		icon: require("../public/assets/UX Research.png"),
		title: "UX Research",
		description:
	...
	{
		icon: require("../public/assets/Interaction Design.png"),
	...
	{
		icon: require("../public/assets/Interpersonal Skills.png"),
