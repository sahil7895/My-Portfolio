...
const contact = () => {
	return (
		<>
			<Head>
				<title>Sheikh Sahil | Contact</title>
				<meta
					name="description"
						...
						<div className={styles.content}>
							...
							>
								<SocialIcon
									title="Phone"
									icon="fa-phone"
									content="+91 8305611387"
								/>
								<SocialIcon
									title="Email"
									icon="fa-envelope"
									content="sahilshaikh3523@gmail.com"
								/>
							</div>
						</div>
						<div
						...
						>
							<form>
								<div className={styles.group}>
									<input type="text" placeholder="Sahil Sheikh" />
									<input type="email" placeholder="sahilshaikh3523@gmail.com" />
								</div>
